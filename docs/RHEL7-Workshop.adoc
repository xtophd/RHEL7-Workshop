...
[#toc]
  ...
  . link:{includedir}/r7-perftune.adoc[*TuneD, NUMAd, Perfomance CoPilot* - System Analysis & Tuning]
  . link:{includedir}/r7-storage.adoc[*LVM, SSM, VDO* - Storage Management]
  . link:{includedir}/r7-nmcli.adoc[*NMcli, Bonding, Teaming* - Network Management]
  . link:{includedir}/r7-firewalld.adoc[*Firewalld* - Firewall Management]

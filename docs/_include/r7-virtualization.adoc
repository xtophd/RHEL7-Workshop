...
----
nmcli con modify type bridge con-name virbr1 ifname virbr1 autoconnect yes bridge.stp no ipv6.method ignore
----
...
----
nmcli con modify enp0s31f6 connection.master virbr2 connection.slave-type bridge
----

...
virt-install --name=${VM_NAME} --ram=16000 --location=/var/lib/libvirt/images/rhel-8.1-x86_64-dvd.iso  --disk /var/lib/libvirt/images/${VM_NAME}.qcow2,bus=scsi,sparse=no,size=25 --graphics vnc --extra-args="ks=${KS_URL}"
----

...
We can also review the overall system performance using pmstat command. The following command uses th epreviously identified log file ${MYPCPLOG} to display 7 statistic entries starting from 00:33:00.

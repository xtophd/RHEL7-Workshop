...
=== Configure SSH Keys for Clients
...
The ansible "setup" module runs at the begining of each play and collects "facts" about a host.  In this example, you will specifically only collects facts about the network interface "eth0".
